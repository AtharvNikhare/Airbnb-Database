...
CREATE TABLE IF NOT EXISTS `airbnbseattledb1`.`Host_has_Listing` (
  ...
  `weekly_price` VARCHAR(10) NULL,
  `monthly_price` VARCHAR(10) NULL,
  `security_deposit` VARCHAR(10) NULL,
  `cleaning_fee` VARCHAR(10) NULL,
  `guests_included` INT NULL,
  `extra_people` VARCHAR(10) NULL,
  ...
  INDEX `fk_Host_has_Listing_ScrapedData1_idx` (`Scrape_ID` ASC) ,
  INDEX `fk_Host_has_Listing_Cancellation Policy1_idx` (`CancellationPolicyID` ASC) ,
  INDEX `fk_Host_has_Listing_Host1_idx` (`HostID` ASC) ,
  INDEX `fk_Host_has_Listing_Listing1_idx` (`ListingID` ASC) ,
